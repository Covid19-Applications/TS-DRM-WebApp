            ...
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p class="font-italic">
                  ...
                  List of government approved Health centers
                  <br>
                  <a href=" https://covid19.telangana.gov.in/health-facilities/" class="btn-buy"><button id="mapsbtn">TESTING CENTERS</button></a>
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='telangana'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN TELANGANA</h1>
  <br><br>
  <CENTER>
  <div ><a href="https://covid19.telangana.gov.in/health-facilities/isolation-centres/">
             <button id="mapsbtn">SEARCH DEDICATED COVID HOSPITALS</button></a>
            </div></CENTER>
<!-- <center>
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Telangana';
