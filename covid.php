        ...
        <div class="container">
          <div class="row">
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center">
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/tel/map.jpg" alt="Image Placeholder" class="img-fluid"></a>
                 
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">TELANGANA ANALYSIS</h3>
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  ...
                  <span style="color: slategray">34 Street Name, Telangana, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: slategray" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: slategray">Email:</span><span>info@etelangana.com</span></li>
              </ul>
            </div>
          </div>
